...
export const BRANCHES: { id: BranchId; name: string; blurb: string; color: string }[] = [
  ...
  },
  {
    id: 'puissance',
    name: 'Puissance',
    blurb: "Ce que l'alchimiste encaisse et rend.",
    color: '#e0a13c',
  },
  {
    id: 'brume',
    name: 'Brume',
    blurb: 'Ce que la ville noyée consent à rendre.',
    color: '#62d4c4',
  },
];
...
export const NODES: TechNode[] = [
  ...
  },
  {
    ...
    effect: (n) => `Volatilité +${(1.5 * n).toFixed(1)} %`,
    max: 20,
    costBase: 14,
    costGrowth: 1.38,
  ...
  },
  {
    ...
    effect: (n) => `Réaction en chaîne +${(1.2 * n).toFixed(1)} %`,
    max: 25,
    costBase: 20,
    costGrowth: 1.4,
  ...
  },
  {
    ...
    effect: (n) => `Clairvoyance +${(0.7 * n).toFixed(1)} % · Rupture +${6 * n} %`,
    max: 25,
    costBase: 30,
    costGrowth: 1.44,
  ...
  },
  {
    ...
    effect: (n) => `Osmose +${(0.9 * n).toFixed(1)} %`,
    max: 20,
    costBase: 10,
    costGrowth: 1.34,
  },
  {
    ...
    branch: 'brume',
    name: 'Rosée captive',
    effect: (n) => `Condensation +${(0.3 * n).toFixed(1)} %/s`,
    max: 15,
    costBase: 12,
    costGrowth: 1.36,
